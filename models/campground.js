...
//Waits for campground to be saved for the first time, then adds slug
campgroundSchema.pre("save", async function(next) {
    try {
        //check for save, or if the name is modified
...
//Waits for a campground to be removed then destroys its comments to
